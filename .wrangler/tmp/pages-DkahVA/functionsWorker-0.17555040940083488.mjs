...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/_internal/utils.mjs
// @__NO_SIDE_EFFECTS__
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/console.mjs
import { Writable } from "node:stream";

// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/mock/noop.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
globalThis.console = console_default;

// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/process/hrtime.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/process/process.mjs
import { EventEmitter } from "node:events";

// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/tty/read-stream.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/tty/write-stream.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/unenv/dist/runtime/node/internal/process/node-version.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../../../.npm/_npx/c943b712072b77c4/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
function auth(request, env2) {
  if (!env2.EDITOR_USER || !env2.EDITOR_PASS) return false;
  const h = request.headers.get("Authorization") || "";
  if (!h.startsWith("Basic ")) return false;
  try {
    const d = atob(h.slice(6)), i = d.indexOf(":");
    return i > 0 && safeEqual(d.slice(0, i), env2.EDITOR_USER) && safeEqual(d.slice(i + 1), env2.EDITOR_PASS);
  } catch {
    return false;
  }
}
__name(auth, "auth");
var json = /* @__PURE__ */ __name((x, s = 200) => new Response(JSON.stringify(x), { status: s, headers: { "content-type": "application/json; charset=utf-8", "cache-control": "no-store", "x-content-type-options": "nosniff" } }), "json");
async function onRequestGet({ request, env: env2 }) {
  if (!env2.PORTFOLIO_CONFIG) return json({ state: null, storage: "unbound" });
  const v = new URL(request.url).searchParams.get("version") || "studio";
  const raw = await env2.PORTFOLIO_CONFIG.get("site-config:" + v);
  return json(raw ? JSON.parse(raw) : { state: null });
}
__name(onRequestGet, "onRequestGet");
async function onRequestPost({ request, env: env2 }) {
  if (!env2.EDITOR_USER || !env2.EDITOR_PASS) return json({ error: "Editor credentials are not configured. Set EDITOR_USER and EDITOR_PASS as secrets on this Pages project, then redeploy.", code: "no-credentials" }, 501);
  if (!auth(request, env2)) return json({ error: "Wrong username or password.", code: "bad-credentials" }, 401);
  let body;
  try {
  ...
  if (body?._authCheck) return json({ ok: true });
  if (!env2.PORTFOLIO_CONFIG) return json({ error: "PORTFOLIO_CONFIG KV binding is not configured" }, 503);
  const v = body?.version || "studio";
  if (!["studio", "gallery"].includes(v) || !body?.state) return json({ error: "Invalid payload" }, 400);
  const data = JSON.stringify({ state: body.state, updatedAt: (/* @__PURE__ */ new Date()).toISOString() });
  if (data.length > 8e5) return json({ error: "Config too large" }, 413);
  await env2.PORTFOLIO_CONFIG.put("site-config:" + v, data);
